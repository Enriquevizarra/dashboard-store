...
function Car(props) {
  ...
  return (
    <div
      className={`lg:col-span-2  fixed lg:right-0 lg:w-96 top-0 bg-[#1F1D2B] w-full h-full transition-all ${
        showOrder ? "right-0 z-10" : "-right-full"
      }`}
    >
      {/* orders */}
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4  ">
              <div className="grid grid-cols-6 mb-4">
                ...
                <div className="col-span-4 flex items-center gap-2">
                  <img src={areopuerto} className="w-16 h-16 object-cover" />
                  <div>
                    <h5 className="text-sm">Spacy Seasoned sea...</h5>
